 ...
 javax.swing.table.DefaultTableModel cursor;
  private int posreg;
    ...
    private void initComponents() {
        ...
        devo = new javax.swing.JRadioButton();
        ...
        grilla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Tipo", "Descripcion", "Estado"
            }
        ) {
        ...
        devo.setText("Devolucion");
        devo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                devoActionPerformed(evt);
            }
        });
        ...
        jLabel1.setText("Motivos Varios");
    ...
    private void txtdescripcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtdescripcionActionPerformed
        ...
        ValidarDuplicados = "SELECT mo_mer_des FROM motivo_merma "
                        + "WHERE trim(mo_mer_des) ='"+TextoValidar+"' ";
        try
        {
...
//        }
    ...
    private void devoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_devoActionPerformed
        // TODO add your handling code here:
         if(devo.isSelected()==true)
        {  
            merma.setSelected(false);
            ajuste.setSelected(false);
            moti= "DEVOLUCION";
    }               
    }//GEN-LAST:event_devoActionPerformed

    private void mermaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mermaActionPerformed
        // TODO add your handling code here:
             if(merma.isSelected()==true)
        {  
            devo.setSelected(false);
            ajuste.setSelected(false);
            moti= "MERMA";
    }    
...
//    public String band="" ;
    ...
    private javax.swing.JRadioButton devo;
     ...
     private void gencod()
    {
        try {
            //       Main.inicio = "no";
                   ver_conex conn = new ver_conex();
                   conn.sentencia = conn.conexion.createStatement();
                   conn.resultado = conn.sentencia.executeQuery("SELECT IFNULL(MAX(mot_cod),0)+ 1 AS xxx FROM motivos");
                   conn.resultado.next();
       ...
       private void grabar()
    {
        try {
            ...
            if(bandera.equals("agregar"))
             {
              ...
              conn.sentencia.executeUpdate("INSERT INTO motivos(mot_cod,mot_desc,mot_est,mot_tipo)values("+txtcod.getText()+",'"+txtdescripcion.getText()+"','ACTIVO','"+moti+"')");
             cargar_grilla();
            ...
            if(bandera.equals("editar"))
             {
               conn.sentencia.executeUpdate("UPDATE motivos SET mot_desc='"+txtdescripcion.getText()+"' WHERE mo_mer_cod ="+txtcod.getText());
            cargar_grilla();
             }
...
this.bcancelar.doClick();
        ...
        private void buscar()
    {
       ...
       ("SELECT * FROM motivo_merma WHERE mo_mer_cod = "+txtcod.getText());
            boolean encontro = conn.resultado.next();

            if(encontro == true)
            {
                txtdescripcion.setText(conn.resultado.getString("mo_mer_des"));
   ...
   if(bandera.equals("borrar"))
                {
                    int mensaje = JOptionPane.showConfirmDialog(this,"Deseas Borrar-->"+txtdescripcion.getText(),"Confirmar",JOptionPane.YES_NO_OPTION);
                     ...
                     {
                          conn.sentencia = conn.conexion.createStatement();
                          conn.sentencia.executeUpdate("UPDATE motivod SET mot_est ='Borrado' Where mot_cod= "+txtcod.getText()+"");
  ...
  private void cargar_grilla()
  {
      try
      {
           for (int i = grilla.getRowCount()-1; i>=0; i--)
            ...
            ver_conex conn = new ver_conex();
            conn.sentencia = conn.conexion.createStatement();
            conn.resultado = conn.sentencia.executeQuery("SELECT * from motivos");
           
            while(conn.resultado.next())
            {
                Object[] datos = {conn.resultado.getString("mot_cod"),conn.resultado.getString("mot_tipo"),conn.resultado.getString("mot_desc"),conn.resultado.getString("mot_est"),
   ...
   private void comparar()
     {
            ...
            texto.toUpperCase();
            ValidarDuplicados="SELECT mo_mer_des as descripcion FROM motivo_merma WHERE mo_mer_des='"+texto+"'";
            try
            {
            conn.sentencia = conn.conexion.createStatement();
            conn.resultado = conn.sentencia.executeQuery(ValidarDuplicados);
