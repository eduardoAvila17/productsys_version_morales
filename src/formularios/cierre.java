...
public class cierre extends javax.swing.JFrame {
    ...
    public cierre() throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        initComponents();
...
//        }
    ...
    private void initComponents() {
        ...
        cie_monto = new javax.swing.JTextField();
        ...
        cie_monto.setEditable(false);
        cie_monto.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        cie_monto.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED), "MONTO CIERRE", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        cie_monto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cie_montoActionPerformed(evt);
            }
        });
        cie_monto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                cie_montoKeyTyped(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cie_monto, javax.swing.GroupLayout.PREFERRED_SIZE, 316, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(19, 19, 19)
                .addComponent(cie_monto, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jLabel6.setText("FORMULARIO DE CIERRE DE CAJA");
        ...
        salir1.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        salir1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/iconfinder-lock-4341303_120563.png"))); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(grabar, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        setSize(new java.awt.Dimension(754, 397));
...
//            this.monto_cierre.setText("");
    ...
    private void cie_montoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cie_montoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cie_montoActionPerformed

    private void cie_montoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cie_montoKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_cie_montoKeyTyped
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(cierre.class.getName()).log(Level.SEVERE, null, ex);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(cierre.class.getName()).log(Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    Logger.getLogger(cierre.class.getName()).log(Level.SEVERE, null, ex);
...
//                 conn.sentencia.executeUpdate(SQL1);
    ...
    private void click_cerrar() {
        ...
        if (res == javax.swing.JOptionPane.OK_OPTION) {
            ...
            SQL1 = "update aper_cierre set fecha_cierre = '" + fecha.getText() + "',monto_cierre = '"+cie_monto.getText()+"',hora_cierre = '" + txthora.getText() + "' ,estado=  '3' where id_caja= '" + combcaja.getSelectedItem() + "' and id= " + num.getText() + "";
    ...
    private void buscarAperturas() {
        try {
            ver_conex conn = new ver_conex();//instanciamos
            conn.sentencia = conn.conexion.createStatement();
            conn.resultado = conn.sentencia.executeQuery("SELECT SUM(CV.VENTA_TOTAL) AS MONTO_CIERRE,\n"
                    ...
                    + "                    INNER JOIN CABECERA_VENTAS CV ON CV.APER_COD = AC.ID\n"
                    + "                    WHERE AC.ESTADO = '2'\n"
...
//            txthora.setText(conn.resultado.getString("HORA_APERTURA"));
            ...
            cie_monto.setText(conn.resultado.getString("MONTO_CIERRE"));
            grabar.setEnabled(true);
...
//     public String opcion="";
    ...
    private javax.swing.JTextField cie_monto;
    ...
    private void buscarApertura(){
        JTextField[] tfParam = new JTextField[1];
            ...
            String sql = "SELECT \n"
                    ...
                    + "INNER JOIN USUARIO U ON U.USU_COD = AC.USU_COD\n"
                    + "WHERE AC.ESTADO = 2\n"
                    + "AND AC.SUCU_COD = " + this.sucu_cod.getText() + " AND AC.ID LIKE";
