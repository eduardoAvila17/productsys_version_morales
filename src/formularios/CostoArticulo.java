 ...
 * @author eavila
 */
public class CostoArticulo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Mantenimiento de Precios");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(bgrabar, javax.swing.GroupLayout.PREFERRED_SIZE, 73, Short.MAX_VALUE)
        ...
        jLabel7.setText("Precio Venta Actual:");
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtbarra, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void bgrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bgrabarActionPerformed
        try {
            ...
            Logger.getLogger(CostoArticulo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CostoArticulo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void buscarcod() throws SQLException {
        ...
        conn.resultado = conn.sentencia.executeQuery("SELECT prd_cod,barra,descripcion,costo,precio_venta\n"
                + "FROM producto\n"
                + "WHERE estado = 1\n"
                + "AND barra =" + this.txtbarra.getText());
        if (conn.resultado.next())//si encontro
        {
            ...
            this.txtbarra.setEnabled(false);
    ...
    private void tirar_grilla() {
        try {
            do {
                ...
                String campos[] = new String[]{String.valueOf(c), txtbarra.getText(), produdesc.getText(), costo.getText(), actual.getText(), nuevoPrecio.getText()};
                dt.addRow(campos);
    ...
    private void gencod() {
        try {
            ...
            txtId.setText(conn.resultado.getString("newcod"));
    ...
    private void grabar() throws SQLException {
        ...
        if (bandera.equals("agregar")) {
            ...
            conn.sentencia.executeUpdate("INSERT INTO cabecera_precios (id,fecha,hora,usuario,estado) VALUES (" + txtId.getText() + ",'" + fecha.getText() + "','" + hora.getText() + "','" + usr.getText() + "'," + 1 + ")");
            //graba en el detalle

            for (int fila = 0; fila < grillacambioprecio.getRowCount(); fila++) {
                conn.sentencia = conn.conexion.createStatement();
                conn.sentencia.executeUpdate("INSERT INTO detalle_precios(id_cabecera,plu,descripcion,costo,prec_actual,prec_nuevo,estado)values(" + txtId.getText() + "," + grillacambioprecio.getValueAt(fila, 1) + ",'" + grillacambioprecio.getValueAt(fila, 2) + "'," + grillacambioprecio.getValueAt(fila, 3) + "," + grillacambioprecio.getValueAt(fila, 4) + "," + grillacambioprecio.getValueAt(fila, 5) + "," + 1 + ")");
                conn.sentencia = conn.conexion.createStatement();
